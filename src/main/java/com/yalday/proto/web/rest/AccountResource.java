...
import com.yalday.proto.domain.PersistentToken;
...
import com.yalday.proto.web.rest.vm.KeyAndPasswordVM;
import com.yalday.proto.web.rest.vm.ManagedUserVM;
                ...
                .orElseGet(() -> {
                    User user = userService
                        .createUser(managedUserVM.getLogin(), managedUserVM.getPassword(),
                            ...
                            managedUserVM.getLangKey(), managedUserVM.getUserType(), managedUserVM.getMerchants());
        ...
        return userRepository
            ...
            .map(u -> {
                userService.updateUser(userDTO.getFirstName(), userDTO.getLastName(), userDTO.getEmail(),
                    userDTO.getLangKey(), userDTO.getUserType(), userDTO.getMerchants(), userDTO.getImageUrl());
