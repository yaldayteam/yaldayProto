...
public class MerchantResourceIntTest {
    ...
    public void createMerchant() throws Exception {
        ...
        assertThat(testMerchant.getBgColor()).isEqualTo(DEFAULT_BG_COLOR);
        assertThat(testMerchant.getTextColor()).isEqualTo(DEFAULT_TEXT_COLOR);
    ...
    public void getAllMerchants() throws Exception {
        ...
        restMerchantMockMvc.perform(get("/api/merchants?sort=id,desc"))
                ...
                .andExpect(jsonPath("$.[*].bgColor").value(hasItem(DEFAULT_BG_COLOR.toString())))
    ...
    public void getMerchant() throws Exception {
        ...
        restMerchantMockMvc.perform(get("/api/merchants/{id}", merchant.getId()))
            ...
            .andExpect(jsonPath("$.bgColor").value(DEFAULT_BG_COLOR.toString()))
    ...
    public void updateMerchant() throws Exception {
        ...
        assertThat(testMerchant.getBgColor()).isEqualTo(UPDATED_BG_COLOR);
        assertThat(testMerchant.getTextColor()).isEqualTo(UPDATED_TEXT_COLOR);
